...
public static class Paths
{
    ...
    public static string GetSolutionDirectory()
    {
        ...
        // Walk up the directory tree to find TwBlazor.Docs folder
        while (!string.IsNullOrEmpty(currentDir))
        {
            // Look for TwBlazor.Docs folder or .sln file
            if (Directory.GetFiles(currentDir, "*.slnx").Length > 0 ||
                Directory.Exists(CombineDir(currentDir, "TwBlazor.Docs")))
                return currentDir;
    ...
    public static string DocsProjectPath => CombineDir(GetSolutionDirectory(), "TwBlazor.Docs");
    ...
    public static string ThemeCsFilePath => Path.Combine(GetSolutionDirectory(), "TwBlazor.Theme", "Theme.cs");
    public static string ServerProgramCsFilePath => Path.Combine(GetSolutionDirectory(), "TwBlazor.Server", "Program.cs");
}
