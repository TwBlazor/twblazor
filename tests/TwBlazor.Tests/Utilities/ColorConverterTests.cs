...
public class ColorConverterTests
{
    ...
    {
        Assert.Equal(0.0, ColorConverter.RelativeLuminance(0, 0, 0), precision: 5);
    }

    [Fact]
    public void RelativeLuminance_White_IsOne()
    {
        Assert.Equal(1.0, ColorConverter.RelativeLuminance(255, 255, 255), precision: 5);
    }

    [Fact]
    public void RelativeLuminance_IsMonotonic_AsChannelsBrighten()
    {
        var darker = ColorConverter.RelativeLuminance(50, 50, 50);
        var lighter = ColorConverter.RelativeLuminance(150, 150, 150);
    ...
    public void ContrastRatio_BlackAgainstWhite_IsMaximum()
    {
        ...
        var result = ColorConverter.ContrastRatio(0, 0, 0, 255, 255, 255);
    ...
    {
        var result = ColorConverter.ContrastRatio(100, 100, 100, 100, 100, 100);
    ...
    {
        var forward = ColorConverter.ContrastRatio(0, 0, 0, 255, 255, 255);
        var reversed = ColorConverter.ContrastRatio(255, 255, 255, 0, 0, 0);
    ...
    {
        var hexResult = ColorConverter.ContrastRatio("#9810fa", "#1d232a");
        var rgbResult = ColorConverter.ContrastRatio(0x98, 0x10, 0xfa, 0x1d, 0x23, 0x2a);
    ...
    {
        var withAlpha = ColorConverter.ContrastRatio("#9810faAA", "#1d232a");
        var withoutAlpha = ColorConverter.ContrastRatio("#9810fa", "#1d232a");
    ...
    public void FindMinimumPassingColor_ReturnsColor_ThatActuallyPasses()
    {
        ...
        var result = ColorConverter.FindMinimumPassingColor("#9810fa", "#1d232a", 4.5);

        Assert.NotNull(result);
        var actualRatio = ColorConverter.ContrastRatio(result.Value.Hex, "#1d232a");
    ...
    public void FindMinimumPassingColor_Darkens_WhenForegroundAlreadyDarkerThanBackground()
    {
        ...
        // of the two.
        var result = ColorConverter.FindMinimumPassingColor("#777777", "#f5f5f5", 4.5);
    ...
    public void FindMinimumPassingColor_ReturnsNull_WhenRatioIsUnreachable()
    {
        ...
        var result = ColorConverter.FindMinimumPassingColor("#808080", "#808080", 21.0);
    ...
    public void FindMinimumPassingColor_AlreadyPassing_ReturnsCloseToOriginal()
    {
        ...
        var result = ColorConverter.FindMinimumPassingColor("#000000", "#ffffff", 4.5);
