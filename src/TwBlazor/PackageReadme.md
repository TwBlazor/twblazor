...
[API Documentation (docfx)](https://twblazor.github.io/twblazor/) • [Component Documentation (twblazor.com)](https://twblazor.com/) • [Get Started](https://twblazor.com/get-started)

## Setup

1. Install the [TwBlazor NuGet package](https://www.nuget.org/packages/TwBlazor) in your Blazor project.
```pwsh
$ dotnet add package TwBlazor --version 1.7.0
```
...
@using TwBlazor
```
4. Add a new static class `Theme` to configure the TwBlazor theme, ensuring Tailwind CSS targets this file for class compilation. You can view the default theme in the [TwBlazor.Theme](https://github.com/TwBlazor/TwBlazor/blob/main/src/TwBlazor.Theme/Theme.cs) project for reference and use it as a base for your own custom theme.
